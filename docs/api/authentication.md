...
**Status:** design only — not yet implemented. This documents the approved contract for Milestone 2 (see [docs/roadmap.md](../roadmap.md)). It will be updated to match the real implementation, including any corrections found during coding, in the same PR that implements Milestone 2 — until then, treat this as the spec, not a description of running behavior.
